...
public class Level6Code : MonoBehaviour {

	public float freqOfFire = 100;
	public float bulletSpeed = 20;
	
	public int numBoxes = 31;
	public int boxesLeft = 31;
	public int numRedBoxes = 12;
	public int numYellowBoxes = 12;
	public int numGreenBoxes = 7;
