...
public class Level7Code : MonoBehaviour {

	public float freqOfFire = 80;
	public float bulletSpeed = 25;
	
	public int numBoxes = 43;
	public int boxesLeft = 34;
	public int numRedBoxes = 20;
	public int numYellowBoxes = 14;
	public int numGreenBoxes = 0;
